...
namespace Benzin_istasyonu
{
    public partial class Form1 : Form
    {
        ...
        double D_benzin95 = 0, D_benzin97 = 0, D_dizel = 0,D_eurodizel=0, D_lpg = 0; //depodaki yakıt miktarının tutacağımz değişkenler max 1000lt
        double E_benzin95 = 0, E_benzin97 = 0, E_dizel = 0,E_eurodizel=0, E_lpg = 0;  //eklenen
        double F_benzin95 = 0, F_benzin97 = 0, F_dizel = 0, F_eurodizel = 0, F_lpg = 0;//fiyat bilgileri
        double S_benzin95 = 0, S_benzin97 = 0, S_dizel = 0, S_eurodizel = 0, S_lpg = 0;//satılan fiyat bilgisi
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (numericUpDown1.Enabled == true)
            {
                ...
                label27.Text=Convert.ToString(S_benzin95 * F_benzin95); 
            }
            else if (numericUpDown2.Enabled == true)
            {
                D_benzin97 = D_benzin97 - S_benzin95;
                label27.Text = Convert.ToString(S_benzin97 * F_benzin97);

            }
            else if (numericUpDown3.Enabled == true)
            {
                D_dizel = D_dizel - S_dizel;
                label27.Text = Convert.ToString(S_dizel * F_dizel);
            }
            else if (numericUpDown4.Enabled == true)
            {
                D_eurodizel = D_eurodizel - S_eurodizel;
                label27.Text = Convert.ToString(S_eurodizel * F_eurodizel);
            }
           else if (numericUpDown5.Enabled == true)
            {
                D_lpg = D_lpg - S_lpg;
                label27.Text = Convert.ToString(S_lpg * F_lpg);
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            System.IO.File.WriteAllLines(Application.StartupPath+"\\depo.txt",depo_bilgileri);//eklendiği için yeniden yazdırman gerek
        ...
        {
            label6.Text=D_benzin95.ToString("N");  // n virgüldn sonraki basamak sayısını 2 olarak ayarlar
        ...
        private void numaricupdown_value()
        {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            numericUpDown1.ReadOnly = true; // dışarıdan sayı girişi yapılamaz
